...
const Header = () => {
  return (
    ...
    <header className="flex justify-between xs:items-start xs:justify-start">
<div className="logo-wrapper flex items-center mr-[4rem] ml-[4rem] xs:ml-[1.5rem] xs:bg-black">
        <img src="../../public/images/easeplanlogo.png" alt="easeplan logo" />
        <div className="text-left w-f">
          <p className="logo-text text-base xs:text-[12px]">
