        ...
        <div className="subscribe py-6 px-4 md:px-6 w-full">
          ...
          <div className="mt-6 flex space-x-5 md:flex-row justify-center items-center">
            <input
              ...
              className="px-2 py-2 border border-gray-300 text-[7px] focus:outline-none focus:border-primary md:mr-4 md:mb-0"
            />
            <button
              className="text-gray-500 bg-gray-200 px-6 py-2 text-[7px] hover:bg-opacity-90 transition duration-300 w-11"
