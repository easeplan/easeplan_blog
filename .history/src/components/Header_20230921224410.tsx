...
const Header = () => {
  return (
    ...
    <header className="flex justify-between xs:justify-start xs:bg-black items-left">
      <div className="logo-wrapper flex items-center xs:mr-1 xs:bg-teal-500">
      ...
      <button className="sm:hidden ml-auto focus:outline-none" aria-label="Menu">
        <svg
          className="h-6 w-6 fill-current text-gray-700 dark:text-gray-300 ml-28 sm:bg-gray-200 "
