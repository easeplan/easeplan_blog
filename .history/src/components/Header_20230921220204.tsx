...
const Header = () => {
  return (
    ...
    <header className="flex justify-between items-center px-4 md:px-8 bg-white dark:bg-gray-800 shadow-md">
    ...
    <nav className="hidden sm:flex space-x-4 items-center justify-center">
        <ul className="flex space-x-4">
            <li><a href="/" className="text-gray-700 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400">News</a></li>
            <li><a href="/about" className="text-gray-700 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400">Events Planners</a></li>
            <li><a href="/contact" className="text-gray-700 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400">Service Providers</a></li>
        </ul>
    </nav>
    <button className="sm:hidden ml-auto focus:outline-none" aria-label="Menu">
