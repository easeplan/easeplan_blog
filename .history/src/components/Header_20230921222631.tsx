  ...
  return (
    ...
    <header className="flex justify-between">
      ...
      <button className="sm:hidden ml-auto focus:outline-none" aria-label="Menu">
        <svg
          className="h-6 w-6 fill-current text-gray-700 dark:text-gray-300 ml-28 sm:bg-gray-200 sm:rounded-full sm:p-2 sm:mr-4 sm:mt-2 sm:ml-auto sm:hover:bg-gray-300 sm:focus:bg-gray-300 sm:focus:outline-none sm:active:bg-gray-300 sm:active:outline-none"
