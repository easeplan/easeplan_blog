...
const Footer = () => {
  return (
    <section className="footer bg-primary py-12">
      <div className="container mx-auto">
        <div className="bg-secondary py-6 px-4 md:px-6">
          <h2 className="text-primary text-center text-3xl md:text-5xl font-bold">
          ...
          <div className="mt-6 flex flex-col md:flex-row justify-center items-center">
            <input
              ...
              className="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-primary md:mr-4 mb-2 md:mb-0"
            />
            <button
              className="bg-primary text-gray-500 bg-gray-200 px-6 py-2 text-lg font-semibold hover:bg-opacity-90 transition duration-300"
            >
              Subscribe
            </button>
          </div>
