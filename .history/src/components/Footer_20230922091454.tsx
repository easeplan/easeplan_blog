    ...
    <section className="footer py-12">
      <div className="container mx-auto">
        <div className="subscribe py-6 px-4 md:px-6 w-full">
          ...
          <div className="mt-6 flex space-x-5 justify-center md:flex-row justify-center items-center">
            <input
              type="email"
              placeholder="Enter email address"
              className="px-2 py-1 border border-gray-300 focus:outline-none focus:border-primary md:mr-4 mb-2 md:mb-0"
            />
            <button
              className="bg-primary text-gray-500 bg-gray-200 px-6 py-1 text-lg font-semibold hover:bg-opacity-90 transition duration-300"
            >
              Subscribe
            </button>
          </div>
