      ...
      <div className="container mx-auto">
        <div className="subscribe py-6 px-4 md:px-6 w-full">
          ...
          <div className="mt-6 flex space-x-5 md:flex-row justify-center items-center">
            ...
            />
            <button
              className="text-gray-500 bg-gray-200 px-6 py-1 text-xs font-thin hover:bg-opacity-90 transition duration-300"
              style={{backgroundColor:"#174e64",color:"#71f79f", text-transform:"uppercase"}
            >
              Subscribe
            </button>
          </div>
